...
var isAddingTransformation = false;
...
function setup() {
  ...
  let addTransformationButton = createButton("Add Transformation");
  let removeTransformationButton = createButton("Remove Transformation");
  let applyTransformationButton = createButton("Apply Transformation");

  addTransformationButton.mousePressed(() => {
    isAddingTransformation = true;
  });

  removeTransformationButton.mousePressed(() => {
    isAddingTransformation = false;
    transformations.pop();
  });
}
